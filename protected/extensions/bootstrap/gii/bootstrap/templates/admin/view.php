...
$this->menu=array(
	...
	array('label'=>Yii::t('admin', 'Delete {model}', array('{model}'=>Yii::t('model', '<?php echo $this->modelClass ?>'))),'url'=>'#','htmlOptions'=>array('submit'=>array('delete','id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>),'confirm'=>'你确定删除吗?')),
);
?>
