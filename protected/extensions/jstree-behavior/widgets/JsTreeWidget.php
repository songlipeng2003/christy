...
EOD;
        ...
        $baseAssetsUrl= Yii::app()->assetManager->publish( Yii::getPathOfAlias('ext.jstree-behavior.assets') );
        ...
        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/noty/js/noty/jquery.noty.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/noty/js/noty/layouts/center.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/noty/js/noty/themes/default.js', CClientScript::POS_END);
        //js spinner
        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/spin.min.js', CClientScript::POS_END);
        //fancybox
        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/fancybox2/jquery.fancybox.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerCssFile($baseAssetsUrl . '/js/fancybox2/jquery.fancybox.css');

        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/json2/json2.js');

        Yii::app()->clientScript->registerCoreScript('yiiactiveform');

        // jquery.form.js plugin http://malsup.com/jquery/form/
        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/ajaxform/jquery.form.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/ajaxform/form.js', CClientScript::POS_END);
        //jstree
        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/jstree/jquery.jstree.js', CClientScript::POS_END);
        Yii::app()->clientScript->registerScriptFile($baseAssetsUrl . '/js/jstree.behavior.js', CClientScript::POS_END);
    }
